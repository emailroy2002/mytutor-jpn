...
#06.設置者のアドレス(カンマ区切り)
$conf{'mailto'} = 'info@mytutor.co.jp';

#06.送信元アドレス
$conf{'from'} = 'contact@mytutor-jpn.com';

#07.送信完了時にリダイレクトするサンクスページ
$conf{'thanks'} = 'https://www.mytutor-jpn.com/mailform/thanks.html';

#08.設置者に届くメールの件名
$conf{'subject'} = 'ホームページからのお問合せ';
